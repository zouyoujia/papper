...
public abstract class HeaderTransformer {
     ...
     * defined in {@link pulltorefresh.Options#headerLayout}.
     *
     ...
     * to that provided from {@link pulltorefresh.listeners.OnRefreshListener} but is more suitable
     ...
     * event. This is only called when {@link pulltorefresh.Options#refreshOnUp} is set to
     * true.
     */
     ...
     * specified in {@link pulltorefresh.Options#refreshMinimizeDelay}.
     */
