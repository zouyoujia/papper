...
import pulltorefresh.listeners.HeaderViewListener;
import pulltorefresh.viewdelegates.ViewDelegate;

/**
 * The main component of the library. You wrap the views you wish to be 'pullable' within this layout.
 * This layout is setup by using the {@link pulltorefresh.ActionBarPullToRefresh} setup-wizard return by
...
public class PullToRefreshLayout extends FrameLayout {
    ...
    /**
     * Set a {@link pulltorefresh.listeners.HeaderViewListener} which is called when the visibility
